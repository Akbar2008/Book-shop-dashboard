...
export const Card = ({ id, bookUrl, title, description, price, sales }) => {
  ...
  return (
    <div className="w-72 h-96 border-2 border-gray-200 rounded-xl shadow-xl p-5 relative">
      ...
      <button onClick={localStorage.getItem('token') || navigate('/')} className="group relative flex h-10 w-full rounded-xl bg-green-600 font-bold items-center justify-center  text-white">
